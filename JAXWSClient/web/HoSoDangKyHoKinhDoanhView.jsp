                        ...
                        <div class="portlet-boundary portlet-boundary_hosodoanhnghiep_WAR_oepdvcportlet_  portlet-static portlet-static-end portlet-borderless ho-so-doanh-nghiep-portlet " id="p_p_id_hosodoanhnghiep_WAR_oepdvcportlet_INSTANCE_K6UXenJy9mhe_">
				 	 	...
				 	 	<b>3</b>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3">
                                                                            <label class="oep-label-bold">${hoSoXem.getCongDan().getTenCongDan()}</label>
                                                                        </td>
                                                                        <td>
                                                                            Đơn vị tiếp nhận:
                                                                        </td>
                                                                        <td colspan="1">
                                                                            <label class="oep-label-bold">
                                                                                ${hoSoXem.getCoQuanTiepNhan().getTenCoQuanTiepNhan()}
                                                                            </label>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="1">
                                                                            <label class="oep-label-bold">${hoSoXem.getMaHoSo()}</label>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                           <label class="oep-label-bold">${hoSoXem.getTrangThaiHoSo()}</label>
							...
							Xem giấy biên nhận
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <label class="oep-label-bold">${hoSoXem.getThongTinLienHeCongDan().getPhone()}</label>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <label class="oep-label-bold">${hoSoXem.getThongTinLienHeCongDan().getEmail()}</label>
                                                                        </td>
                                                                        <td colspan="2"></td>
                                                                    </tr>
                                                                    <tr>
