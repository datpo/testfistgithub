                        ...
                        <div class="pull-right mt-30">
                            <div class="btn-group mr-20">
                                <button type="button" class="btn btn-default dropdown-toggle a-dropdown btn-avta" data-toggle="dropdown">
                                    ...
                                    <img class="img-thumbnail img-circle pad-2 mr-5" src="/image/user_male_portrait?img_id=0&amp;img_id_token=2dwVk1OM6abmpO5aOcwnI7Z1T%2Bs%3D&amp;t=1576262044898" alt="">Nguyễn Tiến Đạt
                                </button>

                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="/quan-ly-ho-so">Quản lý hồ sơ</a></li>
                                    <li><a href="https://dvc.bacninh.gov.vn/group/control_panel/manage?p_p_id=2&amp;p_p_lifecycle=0&amp;p_p_state=maximized&amp;doAsGroupId=7888111&amp;refererPlid=5233908" target="_target">Quản lý thông tin tài khoản</a></li>
