...
public abstract class HoSoDao {
    ...
    public abstract void insertCoQuanTiepNhanTable(HoSo hoSo, Connection conn)throws SQLException;
    ...
    public void insertUserTable(UserAccount user, Connection conn) throws SQLException {
        String sql = "Insert into User(idUser,username,password,congdan_idCongDan) values(?,?,?,?)";
        ...
        pstm.setInt(4, user.getCongDan().getIdCongDan());
        
        pstm.executeUpdate();
    }
    
    public boolean layUser(String userName, String password, Connection conn) throws SQLException{
        boolean check = true;
