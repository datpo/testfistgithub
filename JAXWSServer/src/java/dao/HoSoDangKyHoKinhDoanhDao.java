...
//    }
    ...
    public HoSo layHoSo(int maHoSo, Connection conn) throws SQLException{
        ...
        if(rs.next()){
           HoSoDangKyHoKinhDoanh hoSoDangKyHoKinhDoanh = new HoSoDangKyHoKinhDoanh();
            ...
            hoSoDangKyHoKinhDoanh.setCoQuanTiepNhan(layCoQuanTiepNhanOfHoSo(hoSoDangKyHoKinhDoanh, conn));
    ...
    public static CoQuanTiepNhan layCoQuanTiepNhanOfHoSo(HoSoDangKyHoKinhDoanh hoSoDangKyHoKinhDoanh, Connection conn) throws SQLException{
        CoQuanTiepNhan cqtn = null;
        String sql = "select * from coquantiepnhan where HoSoHoKinhDoanh_idHoSoHoKinhDoanh = ?";
        PreparedStatement pstm = conn.prepareStatement(sql);
        pstm.setInt(1, hoSoDangKyHoKinhDoanh.getMaHoSo());
        
        ResultSet rs = pstm.executeQuery();
        if(rs.next()){
            CoQuanTiepNhan coquan = new CoQuanTiepNhan();
            int maCoQuanTiepNhan = rs.getInt("idCoQuanTiepNhan");
            String ten = rs.getString("tenCoQuanTiepNhan");
            
            coquan.setIdCoQuanTiepNhan(maCoQuanTiepNhan);
            coquan.setTenCoQuanTiepNhan(ten);
...
//            pstm.setBlob(5, (InputStream) file.getHinhAnh());
    ...
    public void insertCoQuanTiepNhanTable(HoSo hoSo, Connection conn)  throws SQLException{
        hoSoDangKyHoKinhDoanh = (HoSoDangKyHoKinhDoanh) hoSo;
        String sql = "insert into CoQuanTiepNhan(idCoQuanTiepNhan, tenCoQuanTiepNhan, HoSoHoKinhDoanh_idHoSoHoKinhDoanh) values(?,?,?)";
        PreparedStatement pstm = conn.prepareStatement(sql);
        pstm.setInt(1, hoSoDangKyHoKinhDoanh.getCoQuanTiepNhan().getIdCoQuanTiepNhan());
        pstm.setString(2,hoSoDangKyHoKinhDoanh.getCoQuanTiepNhan().getTenCoQuanTiepNhan());
        pstm.setInt(3, hoSoDangKyHoKinhDoanh.getMaHoSo());
    ...
    public void delete(int maHoSo, Connection conn) throws SQLException{
        ...
        // xoa co quan tiep nhan
        String sqlCoQuanTiepNhan = "delete from CoQuanTiepNhan where idCoQuanTiepNhan = ?";
        PreparedStatement p0 = conn.prepareStatement(sqlCoQuanTiepNhan);
        p0.setInt(1, hs.getCoQuanTiepNhan().getIdCoQuanTiepNhan());
        p0.executeUpdate();
        System.out.println("delete Co quan tiep ");
